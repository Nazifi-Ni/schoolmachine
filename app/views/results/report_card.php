...
<head>
    <meta charset="UTF-8">
    <title>Report Card - <?= htmlspecialchars($student->surname . ' ' . $student->first_name) ?></title>
    <style>
        * { box-sizing: border-box; }
        ...
        .container { width: 100%; max-width: 760px; margin: 40px auto; position: relative; background: #fff; padding: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
        
        /* Header Section */
        .header-table { width: 100%; margin-bottom: 10px; text-align: center; }
        ...
        .fee-box { border: 1px solid <?= $brandColor ?>; border-radius: 4px; padding: 0; overflow: hidden; width: 160px; flex-shrink: 0; }
